...
[![tests](https://img.shields.io/badge/tests-313%20passing-brightgreen?style=flat-square)](tests)
...
| Tests | none | 313 across broker, costs, launcher, CLI, codex adapter, integration |
...
**v0.2.7, 313 tests.** Cost attribution survives the case that broke it in v0.1:
